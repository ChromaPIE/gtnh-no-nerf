...
import cn.elytra.mod.gtnn.modules.large_essentia_generator.LargeEssentiaGenerator;
...
public class MTELargeEssentiaGenerator extends MTETooltipMultiBlockBaseEM
	...
	public boolean onRightclick(IGregTechTileEntity aBaseMetaTileEntity, EntityPlayer aPlayer) {
		if (this.getBaseMetaTileEntity()
			...
			if (tCurrentItem != null && tCurrentItem.getItem()
				.equals(
					LargeEssentiaGenerator.INSTANCE.getEssentiaUpgradeEmpty()
						.getItem())) {
	...
	protected MultiblockTooltipBuilder createTooltip() {
		...
		tt.addMachineType("Essentia Generator")
			...
			.addInfo("Supports normal Dynamo Hatches or TecTech ones for up to 64A," + EnumChatFormatting.STRIKETHROUGH + " but no Laser Hatches" + EnumChatFormatting.GRAY + ".")
