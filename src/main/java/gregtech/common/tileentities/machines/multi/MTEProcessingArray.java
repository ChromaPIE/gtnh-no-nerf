...
import static cn.elytra.mod.gtnn.client.NNTextures.GT.OVERLAY_FRONT_PROCESSING_ARRAY;
import static cn.elytra.mod.gtnn.client.NNTextures.GT.OVERLAY_FRONT_PROCESSING_ARRAY_ACTIVE;
import static cn.elytra.mod.gtnn.client.NNTextures.GT.OVERLAY_FRONT_PROCESSING_ARRAY_ACTIVE_GLOW;
import static cn.elytra.mod.gtnn.client.NNTextures.GT.OVERLAY_FRONT_PROCESSING_ARRAY_GLOW;
...
public class MTEProcessingArray extends MTEExtendedPowerMultiBlockBase<MTEProcessingArray>
	...
	protected MultiblockTooltipBuilder createTooltip() {
		...
		tt.addMachineType("Processing Array")
			.addInfo(GTNNText.Tooltips.INSTANCE.getForDeprecatedMachines())
